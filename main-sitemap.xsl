...
})(window,document,'script','dataLayer','GTM-T5V7HLN');</script>
<!-- End Google Tag Manager -->
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - rumahwalet</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Peta Situs XML - rumahwalet</title>
					</xsl:otherwise>
				</xsl:choose>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T5V7HLN"
